...
_Working name: `overload`. Updated 2026-09-22._
...
| --- | --- |
| **M1 — Training log** | Every workout for 4 consecutive weeks is logged in the app, and Yuta never has to guess a working weight. |
